...
public class EmployeeDaoImpl implements IEmployeeDAO {
	...
	private static final String SQL_SELECT_QUERY = "SELECT count(*) from Employee2";
	private static final String SQL_SELECT_QUERY_BY_ID = "select ename from Employee2 where eid=?";
	...
	private static final String INSERT_EMPLOYEE = "insert into Employee2(`ename`,`eage`,`eaddress`,`desg`,`salary`) values(?,?,?,?,?)";
	private static final String ADD_BONUS_EMP_BY_DESG = "update Employee2 set salary=salary+? where desg=?";
